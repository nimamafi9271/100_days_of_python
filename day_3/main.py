# This is the code for day 3 project.
print(r'''
*******************************************************************************
          |                   |                  |                     |
...
if player_choice == 'left':
    player_choice = input('You\'ve come to a lake. There is an Island in the middle of the lake\n'
                          'Type "wait" to wait for a boat. Type "swim" to swim across\n').lower()
    if player_choice == 'wait':
        player_choice = input("You arrive at the island unharmed. There is a house with 3 doors.\n "
